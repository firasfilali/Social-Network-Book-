...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiSpecificationFiras.PageResponseBorrowedBookResponse();
  });
  ...
  describe('PageResponseBorrowedBookResponse', function() {
    it('should create an instance of PageResponseBorrowedBookResponse', function() {
      // uncomment below and update the code to test PageResponseBorrowedBookResponse
      //var instance = new OpenApiSpecificationFiras.PageResponseBorrowedBookResponse();
      //expect(instance).to.be.a(OpenApiSpecificationFiras.PageResponseBorrowedBookResponse);
    });
