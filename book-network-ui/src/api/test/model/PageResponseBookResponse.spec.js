...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new OpenApiSpecificationFiras.PageResponseBookResponse();
  });
  ...
  describe('PageResponseBookResponse', function() {
    it('should create an instance of PageResponseBookResponse', function() {
      // uncomment below and update the code to test PageResponseBookResponse
      //var instance = new OpenApiSpecificationFiras.PageResponseBookResponse();
      //expect(instance).to.be.a(OpenApiSpecificationFiras.PageResponseBookResponse);
    });
